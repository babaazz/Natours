...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiYmFiYS1uYXN0eWMiLCJhIjoiY2xrcG43cHlwMDl0ajNncG5mem8zOHVreiJ9.aQNMeBNCf2yzg9hTBf6big";
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === "data" ? "http://127.0.0.1:3500/api/v1/users/updateMe" : "http://127.0.0.1:3500/api/v1/users/updatePassword";
          _context.next = 4;
          return (0, _axios.default)({
            method: "PATCH",
            url: url,
...
},{"./auth.js":"auth.js","./mapbox.js":"mapbox.js","./updateSettings.js":"updateSettings.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
